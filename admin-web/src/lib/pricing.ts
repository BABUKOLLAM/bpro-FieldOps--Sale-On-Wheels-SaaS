...
export const TIER_FEATURES: Record<Tier, string[]> = {
  Basic: [
    ...
    "GST invoice PDFs + e-way bill generation",
  ...
  Standard: [
    ...
    "Scheme & discount engine, digital signature & OTP proof-of-delivery",
    "Expense tracking with approval workflow",
    "Full fleet management (maintenance, reverse logistics, trip profitability)",
    "Alerts & exception reporting (stock variance, missed visits, inactivity)",
    "Bulk master-data import/export",
    "Push & WhatsApp delivery notifications",
  ],
  Premium: [
    "Everything in Standard, plus:",
    "Generic multi-ERP API layer + Busy / Marg integration",
    "Online UPI / card payment collection at the point of sale",
    "Target vs. achievement analytics, multi-language UI",
    "Advanced fleet: geofencing, driver safety scoring, route-deviation analytics",
    "AI dashboard anomaly insights & rule-based fraud detection",
    "Governed change-request approvals for sensitive settings",
  ],
};
