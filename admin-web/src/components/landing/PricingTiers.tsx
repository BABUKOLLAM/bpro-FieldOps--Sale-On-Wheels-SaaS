        ...
        return (
          <div
            ...
            className={`relative flex flex-col rounded-2xl border p-6 sm:p-7 ${
              popular
                ? "border-green-600 bg-white dark:bg-slate-900 shadow-lg shadow-green-600/10 ring-1 ring-green-600"
                : "border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900"
            }`}
          >
            {popular && (
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-linear-to-r from-yellow-600 to-green-600 px-3 py-1 text-xs font-semibold text-white">
                Most popular
              </span>
            )}
            ...
            <a
              ...
              className={`mt-6 block rounded-lg px-4 py-2.5 text-center text-sm font-semibold transition-colors ${
                popular
                  ? "bg-linear-to-r from-yellow-600 to-green-600 text-white hover:from-yellow-500 hover:to-green-500"
